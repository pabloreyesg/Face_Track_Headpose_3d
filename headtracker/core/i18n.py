...
_TRANSLATIONS = {
    "es": {
        ...
        "camera_generic_name": "Cámara",
        "camera_list_title": "🔍 Detectando cámaras conectadas (integradas y USB)...",
        "camera_list_line": "   [{i}] {name} (índice {index}, {w}x{h})",
        "camera_list_none": "⚠️ No se detectó ninguna cámara.",
        "camera_list_choose": "Seleccione cámara [0-{n}] [{default}]: ",
    ...
    "en": {
        ...
        "camera_generic_name": "Camera",
        "camera_list_title": "🔍 Detecting connected cameras (built-in and USB)...",
        "camera_list_line": "   [{i}] {name} (index {index}, {w}x{h})",
        "camera_list_none": "⚠️ No camera was detected.",
        "camera_list_choose": "Select camera [0-{n}] [{default}]: ",
